...
per the `pom.xml`, by default the most up-to-date cloud drivers are configured. 
...
```
|                           |AWS|Azure|CloudStack|DigitalOcean|GCE|Joyent Cloud|OpenStack|Private vCloud Cloud|vSphere|
|---------------------------|---|-----|----------|------------|---|------------|---------|--------------------|-------|
|admin                      |X  |     |          |            |   |            |         |                    |       |
|   account                 |   |     |          |            |   |            |         |                    |       |
|   billing                 |   |     |          |            |   |            |         |                    |       |
...
|ci                         |   |     |          |            |   |            |         |                    |       |
|---------------------------|---|-----|----------|------------|---|------------|---------|--------------------|-------|
|compute                    |X  |X    |X         |X           |X  |X           |X        |X                   |X      |
|   affinityGroup           |   |X    |          |            |   |            |         |                    |X      |
|   autoScaling             |X  |     |          |            |   |            |         |                    |       |
|   image                   |X  |X    |X         |X           |X  |X           |X        |X                   |X      |
|   snapshot                |X  |     |X         |            |X  |            |X        |                    |       |
|   virtualMachine          |X  |X    |X         |X           |X  |X           |X        |X                   |X      |
